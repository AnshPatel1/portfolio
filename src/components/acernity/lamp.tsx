  ...
  return (
    <LampContainer>
      ...
      {/* <motion.h3
        ...
        className="mt-12 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center font-light tracking-tight text-transparent"
      >
        (trust me, there is <b>nothing</b> down here)
      </motion.h3> */}
    </LampContainer>
  );
}
